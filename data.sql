...
INSERT INTO `yi_admin` VALUES (1,'admin','123456','952867293@qq.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
--
-- Table structure for table `yi_apicode`
--

DROP TABLE IF EXISTS `yi_apicode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yi_apicode` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '接口ID',
  `pid` int(11) DEFAULT NULL COMMENT '项目ID',
  `code` varchar(255) DEFAULT NULL COMMENT '接口码',
  `time` varchar(255) DEFAULT NULL COMMENT '添加时间',
  `request` varchar(255) DEFAULT NULL COMMENT '请求次数',
  `operation` varchar(255) DEFAULT NULL COMMENT '操作',
  `status` enum('y','n') DEFAULT 'y' COMMENT '接口状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `yi_apicode`
--

LOCK TABLES `yi_apicode` WRITE;
/*!40000 ALTER TABLE `yi_apicode` DISABLE KEYS */;
/*!40000 ALTER TABLE `yi_apicode` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yi_code_log`
--

DROP TABLE IF EXISTS `yi_code_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yi_code_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `yi_code_log`
--

LOCK TABLES `yi_code_log` WRITE;
/*!40000 ALTER TABLE `yi_code_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `yi_code_log` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `yi_dcode`
--

DROP TABLE IF EXISTS `yi_dcode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yi_dcode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) DEFAULT NULL,
  `kami_user` varchar(255) DEFAULT NULL,
  `kami_pass` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `yi_dcode`
--

LOCK TABLES `yi_dcode` WRITE;
/*!40000 ALTER TABLE `yi_dcode` DISABLE KEYS */;
/*!40000 ALTER TABLE `yi_dcode` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `yi_notice`
--

DROP TABLE IF EXISTS `yi_notice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yi_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `yi_notice`
--

LOCK TABLES `yi_notice` WRITE;
/*!40000 ALTER TABLE `yi_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `yi_notice` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yi_order`
--

DROP TABLE IF EXISTS `yi_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yi_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order` varchar(255) DEFAULT NULL,
  `time` varchar(255) DEFAULT NULL,
  `uid` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `yi_order`
--

LOCK TABLES `yi_order` WRITE;
/*!40000 ALTER TABLE `yi_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `yi_order` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `yi_project` (
  ...
  `submit_sign` enum('y','n') DEFAULT 'y' COMMENT '提交签名',
...
--
-- Table structure for table `yi_shop`
--

DROP TABLE IF EXISTS `yi_shop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yi_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `yi_shop`
--

LOCK TABLES `yi_shop` WRITE;
/*!40000 ALTER TABLE `yi_shop` DISABLE KEYS */;
/*!40000 ALTER TABLE `yi_shop` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yi_shop_type`
--

DROP TABLE IF EXISTS `yi_shop_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yi_shop_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) DEFAULT NULL,
  `type` varchar(255) DEFAULT NULL,
  `money` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `yi_shop_type`
--

LOCK TABLES `yi_shop_type` WRITE;
/*!40000 ALTER TABLE `yi_shop_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `yi_shop_type` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-07-02 16:50:17
